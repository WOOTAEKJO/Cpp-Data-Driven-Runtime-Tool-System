...
{
public:
	/*enum EFFECT_RESOURCE_LIST {
		RESOURCE_MODEL, RESOURCE_DIFFUSE, RESOURCE_MASK, RESOURCE_NOISE,RESOURCE_DISSOLVE,RESOURCE_END
	};*/
...
public:
	/*GETSET_EX2(vector<wstring>&, m_PrototypeModelList, PrototypeModelList, GET, SET)
	GETSET_EX2(vector<wstring>&, m_PrototypeDiffuseList, PrototypeDiffuseList, GET, SET)
	GETSET_EX2(vector<wstring>&, m_PrototypeMaskList, PrototypeMaskList, GET, SET)
	GETSET_EX2(vector<wstring>&, m_PrototypeNoiseList, PrototypeNoiseList, GET, SET)
	GETSET_EX2(vector<wstring>&, m_PrototypeDissolveList, PrototypeDissolveList, GET, SET)*/
